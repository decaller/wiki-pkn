---
title: 'Alur Materi: Bekerja Sama'
---

# Alur Materi: Bekerja Sama

> [!info] Artikel Lengkap
> Berkas materi lengkap: [[content/Paradigma - Implementasi PKN/Dokumen Pendidikan Karakter Nabawiyah/Paradigma & Implementasi/Insan/Fitrah (Karakter)/Bakat/Bekerja Sama|Bekerja Sama]]

```mermaid
flowchart TD
    subgraph S1["1. Hakikat & Definisi Rumpun"]
        A1["Rumpun Bakat: Bekerja Sama"] --> A2["Fungsi Eksistensial:<br/>Karakteristik dasar fitrah dalam beraktivitas & berkarya"]
        A2 --> A3["Pilar Karakter Terkait:<br/>- Bakat<br/>- Bahasa Lisan<br/>- Imunitas Sosial<br/>- Tangki Cinta<br/>- Bahasa Hati"]
    end
