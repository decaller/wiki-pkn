---
title: 'Alur Materi: Panduan Asesmen dan Observasi TB-40'
---

# Alur Materi: Panduan Asesmen dan Observasi TB-40

> [!info] Artikel Lengkap
> Berkas materi lengkap: [[content/Paradigma - Implementasi PKN/Dokumen Pendidikan Karakter Nabawiyah/Paradigma & Implementasi/Insan/Fitrah (Karakter)/Bakat/Panduan Asesmen dan Observasi TB40|Panduan Asesmen dan Observasi TB-40]]

```mermaid
flowchart TD
    subgraph S1["1. Hakikat & Definisi Rumpun"]
        A1["Rumpun Bakat: Panduan Asesmen dan Observasi TB40"] --> A2["Fungsi Eksistensial:<br/>Karakteristik dasar fitrah dalam beraktivitas & berkarya"]
        A2 --> A3["Pilar Karakter Terkait:<br/>- Tamyiz<br/>- Murahaqah<br/>- Syabab<br/>- Bakat<br/>- Bekerja Keras<br/>- Berpikir"]
    end
