---
title: 'Alur Materi: Berpikir'
---

# Alur Materi: Berpikir

> [!info] Artikel Lengkap
> Berkas materi lengkap: [[content/Paradigma - Implementasi PKN/Dokumen Pendidikan Karakter Nabawiyah/Paradigma & Implementasi/Insan/Fitrah (Karakter)/Bakat/Berpikir|Berpikir]]

```mermaid
flowchart TD
    subgraph S1["1. Hakikat & Definisi Rumpun"]
        A1["Rumpun Bakat: Berpikir"] --> A2["Fungsi Eksistensial:<br/>Karakteristik dasar fitrah dalam beraktivitas & berkarya"]
        A2 --> A3["Pilar Karakter Terkait:<br/>- Bakat<br/>- Insan<br/>- Bahasa Lisan<br/>- Tamyiz<br/>- Tangki Cinta<br/>- Bahasa Hati"]
    end
