---
title: 'Alur Materi: Bekerja Keras'
---

# Alur Materi: Bekerja Keras

> [!info] Artikel Lengkap
> Berkas materi lengkap: [[content/Paradigma - Implementasi PKN/Dokumen Pendidikan Karakter Nabawiyah/Paradigma & Implementasi/Insan/Fitrah (Karakter)/Bakat/Bekerja Keras|Bekerja Keras]]

```mermaid
flowchart TD
    subgraph S1["1. Hakikat & Definisi Rumpun"]
        A1["Rumpun Bakat: Bekerja Keras"] --> A2["Fungsi Eksistensial:<br/>Karakteristik dasar fitrah dalam beraktivitas & berkarya"]
        A2 --> A3["Pilar Karakter Terkait:<br/>- Bakat<br/>- Insan<br/>- Pembelajaran Alamiah<br/>- Perkembangan"]
    end
