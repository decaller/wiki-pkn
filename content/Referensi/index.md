---
title: "Referensi"
description: "Katalog komprehensif referensi Manhaj Pendidikan Karakter Nabawiyah: rekaman kajian video, materi tayang presentasi, korpus dalil klasik, literatur buku cetak, dan panduan kontribusi."
aliases:
  - Pusat Referensi & Sumber Rujukan
  - Sumber Rujukan
tags:
  - referensi
  - direktori
...
Selamat datang di gerbang **Pusat Referensi & Sumber Rujukan** Wiki PKN. Seluruh artikel, modul, dan visualisasi kanvas di dalam portal ini dibangun di atas pondasi dokumen kurikulum resmi, rekaman kajian ilmiah **Ustadz Abdul Kholiq**, serta korpus literatur Islam klasik.

Berikut adalah kluster referensi yang dapat Anda telaah secara terstruktur:

---

## 📚 Direktori Kluster Referensi

| Kluster Referensi | Deskripsi Singkat | Tautan Utama |
| :--- | :--- | :--- |
...
| **📖 Korpus Dalil & Atsar Klasik** | Indeks dalil turats (Kutubus Sittah, tafsir mu'tabar, kitab tarbiyah ulama klasik) yang diverifikasi melalui korpus OpenBayan (seluruh dataset Maktabah Syamilah). | [[Korpus Dalil & Atsar Klasik\|Buka Korpus Dalil]] |
...
| **🎯 Tes Online Tafsir Bakat (TB40)** | Portal pengujian online 40 pilar bakat nabawiyah resmi ([tafsirbakat.com](https://tafsirbakat.com/)) dan platform alternatif Insan Mustaqbal ([tb40.insanmustaqbal.or.id](https://tb40.insanmustaqbal.or.id/) - *tahap pengembangan*). | [Tes di tafsirbakat.com](https://tafsirbakat.com/) • [Alternatif TB40](https://tb40.insanmustaqbal.or.id/) |
| **🚀 Program & Kegiatan Resmi PKN** | Katalog program kaderisasi guru (AKG 17 batch), standarisasi lembaga (PIS), forum musyawarah pimpinan (TDK), karantina Talent Camp, dan Sekolah Tanpa OB. | [[Program dan Kegiatan Pendidikan Karakter Nabawiyah\|Buka Katalog Kegiatan]] |
| **🌐 Portal Resmi Manhaj PKN** | Portal pusat pergerakan Pendidikan Karakter Nabawiyah asuhan Ustadz Abdul Kholiq: artikel ilmiah, pendaftaran event, dan jejaring lembaga. | [Kunjungi karakternabawiyah.com](https://karakternabawiyah.com/) |
...
## 🔍 Integritas Sanad & Rujukan Ilmiah

Setiap materi yang dipublikasikan dalam Wiki PKN berpegang teguh pada prinsip keilmuan Islam:
