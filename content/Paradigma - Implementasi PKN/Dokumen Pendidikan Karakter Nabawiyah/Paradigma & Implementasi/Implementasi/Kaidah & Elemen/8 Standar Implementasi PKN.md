...
# 8 Standar Implementasi Pendidikan Karakter Nabawiyah
...
<div class="wiki-action-bar">
  ...
  <a href="https://github.com/decaller/wiki-pkn/edit/main/content/Paradigma - Implementasi PKN/Dokumen Pendidikan Karakter Nabawiyah/Paradigma & Implementasi/Implementasi/Kaidah & Elemen/8 Standar Implementasi PKN.md" class="wiki-action-item" target="_blank" rel="noopener">✏️ Sunting</a>
  <a href="https://github.com/decaller/wiki-pkn/commits/main/content/Paradigma - Implementasi PKN/Dokumen Pendidikan Karakter Nabawiyah/Paradigma & Implementasi/Implementasi/Kaidah & Elemen/8 Standar Implementasi PKN.md" class="wiki-action-item" target="_blank" rel="noopener">📜 Riwayat</a>
...
<div class="wiki-infobox">
  <div class="wiki-infobox-header">8 Standar Implementasi Pendidikan Karakter Nabawiyah</div>
  ...
  <table class="wiki-infobox-table">
    <tr>
      <th>Topik Inti</th>
      <td><b>8 Standar Implementasi Pendidikan Karakter Nabawiyah</b></td>
    </tr>
    <tr>
...
> **Hakikat Konsep:** **8 Standar Implementasi Pendidikan Karakter Nabawiyah** adalah pilar fundamental dalam Manhaj Pendidikan Karakter Nabawiyah yang mengarahkan proses tarbiyah dari penegakan tauhid batin menuju pembiasaan amal shalih lahiriah.
...
|:---:|---|---|---|
| **1** | Karakter Iman: Tumbuh<br/>Karakter Belajar: Tumbuh<br/>Karakter Bakat: Tumbuh | Telah sesuai tahapan perkembangan usia | Penguatan akselerasi proyek dan bimbingan kepemimpinan (*Qiyadah*) |
| **2** | Karakter Iman: Tumbuh<br/>Karakter Belajar: Tumbuh<br/>**Karakter Bakat: Belum Tumbuh** | Kurang stimulasi ragam peran dan aktivitas | Penajaman bakat menggunakan Standar Pendewasaan (magang & proyek minat khusus) |
| **3** | Karakter Iman: Tumbuh<br/>**Karakter Belajar: Belum Tumbuh**<br/>**Karakter Bakat: Belum Tumbuh** | Terjebak kejenuhan akademik formal | Memperbesar interaksi langsung dengan alam bebas (*Tadabbur Alam*) dan penugasan fisik nyata |
| **4** | **Karakter Iman: Belum Tumbuh**<br/>Karakter Belajar: Belum Tumbuh<br/>Karakter Bakat: Belum Tumbuh | **Hutang Pengasuhan Berat** (*Severe Parenting Debt*) | **Terapi Pemulihan Total (Recovery):** Hentikan seluruh tuntutan akademik; penuhi tangki cinta dengan Bahasa Hati intensif |
...
<div class="presentation-wrapper" style="margin: 1.5rem 0;">
  <h4 style="margin-bottom: 0.5rem; display: flex; align-items: center; gap: 0.5rem;">📊 Pratinjau Materi Presentasi: 7. Evaluasi Pendidikan Karakter Nabawiyah</h4>
  <div class="presentation-container" style="position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; border-radius: 8px; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.1); border: 1px solid var(--lightgray); background: var(--light);">
    <iframe 
      src="https://1drv.ms/p/c/3efe4d3cd3a3788a/IQQr9-RMYilYRr17yIeg1kt0AUhszgyQmECbtoG7PqDpwSQ?em=2&amp;wdAr=1.7777777777777777" 
  ...
  <div class="presentation-actions" style="display: flex; gap: 0.75rem; flex-wrap: wrap; margin-top: 0.6rem; margin-bottom: 0.5rem; font-size: 0.85rem;">
    <a href="https://wikipkn.insanmustaqbal.or.id/presentations/21-evaluasi-pkn.pptx" download style="display: inline-flex; align-items: center; gap: 0.35rem; padding: 0.4rem 0.8rem; background: var(--light); border: 1px solid var(--lightgray); border-radius: 6px; text-decoration: none; color: var(--dark); font-weight: 500;">📥 Unduh Slide PPTX (4.08 MB)</a>
    <a href="https://1drv.ms/p/c/3efe4d3cd3a3788a/IQQr9-RMYilYRr17yIeg1kt0AUhszgyQmECbtoG7PqDpwSQ?em=2" target="_blank" rel="noopener" style="display: inline-flex; align-items: center; gap: 0.35rem; padding: 0.4rem 0.8rem; background: var(--light); border: 1px solid var(--lightgray); border-radius: 6px; text-decoration: none; color: var(--dark); font-weight: 500;">🖥️ Buka Layar Penuh (PowerPoint Online)</a>
...
<div class="presentation-wrapper" style="margin: 1.5rem 0;">
  <h4 style="margin-bottom: 0.5rem; display: flex; align-items: center; gap: 0.5rem;">📊 Pratinjau Materi Presentasi: Panduan Implementasi Standar PKN</h4>
  <div class="presentation-container" style="position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; border-radius: 8px; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.1); border: 1px solid var(--lightgray); background: var(--light);">
    <iframe 
      src="https://1drv.ms/p/c/3efe4d3cd3a3788a/IQScwdxn4y4sQI3_d72dEJ0cAUZRSKWH_bAZn9n_86TG80g?em=2&amp;wdAr=1.7777777777777777" 
      style="position: absolute; top:0; left: 0; width: 100%; height: 100%; border: 0;" 
      frameborder="0" 
      allowfullscreen="true"
  ...
  <div class="presentation-actions" style="display: flex; gap: 0.75rem; flex-wrap: wrap; margin-top: 0.6rem; margin-bottom: 0.5rem; font-size: 0.85rem;">
    <a href="https://wikipkn.insanmustaqbal.or.id/presentations/20-panduan-implementasi-standar-pkn.pptx" download style="display: inline-flex; align-items: center; gap: 0.35rem; padding: 0.4rem 0.8rem; background: var(--light); border: 1px solid var(--lightgray); border-radius: 6px; text-decoration: none; color: var(--dark); font-weight: 500;">📥 Unduh Slide PPTX (37.6 MB)</a>
    <a href="https://1drv.ms/p/c/3efe4d3cd3a3788a/IQScwdxn4y4sQI3_d72dEJ0cAUZRSKWH_bAZn9n_86TG80g?em=2" target="_blank" rel="noopener" style="display: inline-flex; align-items: center; gap: 0.35rem; padding: 0.4rem 0.8rem; background: var(--light); border: 1px solid var(--lightgray); border-radius: 6px; text-decoration: none; color: var(--dark); font-weight: 500;">🖥️ Buka Layar Penuh (PowerPoint Online)</a>
    <a href="https://1drv.ms/f/c/3efe4d3cd3a3788a/IgDcc7tk4xrzRLl5cAMnNZRfAZnQHlpC2x6T2PpXeL_jTzg" target="_blank" rel="noopener" style="display: inline-flex; align-items: center; gap: 0.35rem; padding: 0.4rem 0.8rem; background: var(--light); border: 1px solid var(--lightgray); border-radius: 6px; text-decoration: none; color: var(--dark); font-weight: 500;">☁️ Folder OneDrive Resmi</a>
  </div>  <p style="font-size: 0.85rem; color: var(--gray); margin-top: 0.25rem; font-style: italic;">💡 <strong>Catatan:</strong> Berkas tayang ini berukuran cukup besar (37.6 MB). Jika pratinjau Office Online lambat memuat, disarankan mengklik <strong>Unduh Slide PPTX</strong> untuk membuka di aplikasi PowerPoint lokal.</p>
</div>
