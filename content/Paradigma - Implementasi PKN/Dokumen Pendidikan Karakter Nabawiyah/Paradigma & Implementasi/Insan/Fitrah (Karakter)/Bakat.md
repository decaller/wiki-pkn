...
```mermaid
flowchart TD
    subgraph "Rukun 3A Bakat Nabawiyah"
        A["1. Suka (Al-Hirsh / Enjoy)"] -->|Didorong Hawa Nafs Ammarah| M["Energi & Semangat Alami"]
        B["2. Bisa (Al-Maqdari / Easy)"] -->|Didorong Nalar Lawwamah| M2["Kecepatan Belajar & Penguasaan"]
        C["3. Berguna (Al-Mufid / Excellent)"] -->|Didorong Nurani Muthmainnah| M3["Kemanfaatan Nyata bagi Umat"]
    end
    M & M2 & M3 --> Hasil["Karya Ihsan & Misi Peradaban"]
```
