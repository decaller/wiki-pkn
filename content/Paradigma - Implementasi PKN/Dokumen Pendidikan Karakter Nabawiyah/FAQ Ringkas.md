...
<div class="wiki-action-bar">
  ...
  <a href="https://github.com/decaller/wiki-pkn/edit/main/content/Paradigma - Implementasi PKN/Dokumen Pendidikan Karakter Nabawiyah/FAQ Ringkas.md" class="wiki-action-item" target="_blank" rel="noopener">✏️ Sunting</a>
  <a href="https://github.com/decaller/wiki-pkn/commits/main/content/Paradigma - Implementasi PKN/Dokumen Pendidikan Karakter Nabawiyah/FAQ Ringkas.md" class="wiki-action-item" target="_blank" rel="noopener">📜 Riwayat</a>
...
<div class="wiki-infobox">
  <div class="wiki-infobox-header">FAQ Ringkas</div>
...
> **Hakikat Konsep:** **FAQ Ringkas** adalah pilar fundamental dalam Manhaj Pendidikan Karakter Nabawiyah yang mengarahkan proses tarbiyah dari penegakan tauhid batin menuju pembiasaan amal shalih lahiriah.
...
> **Kasus:** Masyarakat keliru mengira PKN menolak sains modern atau menganggap PKN hanya cocok untuk pesantren pedesaan.
...
> **Kondisi Faktual:** Dalam praktik nyata di lembaga dan rumah tangga, penerapan FAQ Pertanyaan Kunci PKN sering menghadapi tantangan resistensi budaya lama dan tuntutan hasil instan.  
...
> [!warning] Peringatan Risiko: Jebakan Formalitas dalam FAQ Pertanyaan Kunci PKN
...
<div class="presentation-wrapper" style="margin: 1.5rem 0;">
  <h4 style="margin-bottom: 0.5rem; display: flex; align-items: center; gap: 0.5rem;">📊 Pratinjau Materi Presentasi: 10 Masalah Pendidikan Generasi</h4>
  <div class="presentation-container" style="position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; border-radius: 8px; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.1); border: 1px solid var(--lightgray); background: var(--light);">
    <iframe 
      src="https://1drv.ms/p/c/3efe4d3cd3a3788a/IQRw9uzezjxnQpDJxA4BBM-dAYqOV-EO4j3wTneDqdQd9tw?em=2&amp;wdAr=1.7777777777777777" 
  ...
  <div class="presentation-actions" style="display: flex; gap: 0.75rem; flex-wrap: wrap; margin-top: 0.6rem; margin-bottom: 0.5rem; font-size: 0.85rem;">
    <a href="https://wikipkn.insanmustaqbal.or.id/presentations/24-10-masalah-pendidikan.pptx" download style="display: inline-flex; align-items: center; gap: 0.35rem; padding: 0.4rem 0.8rem; background: var(--light); border: 1px solid var(--lightgray); border-radius: 6px; text-decoration: none; color: var(--dark); font-weight: 500;">📥 Unduh Slide PPTX (111.84 MB)</a>
    <a href="https://1drv.ms/p/c/3efe4d3cd3a3788a/IQRw9uzezjxnQpDJxA4BBM-dAYqOV-EO4j3wTneDqdQd9tw?em=2" target="_blank" rel="noopener" style="display: inline-flex; align-items: center; gap: 0.35rem; padding: 0.4rem 0.8rem; background: var(--light); border: 1px solid var(--lightgray); border-radius: 6px; text-decoration: none; color: var(--dark); font-weight: 500;">🖥️ Buka Layar Penuh (PowerPoint Online)</a>
  ...
  </div>  <p style="font-size: 0.85rem; color: var(--gray); margin-top: 0.25rem; font-style: italic;">💡 <strong>Catatan:</strong> Berkas tayang ini berukuran cukup besar (111.84 MB). Jika pratinjau Office Online lambat memuat, disarankan mengklik <strong>Unduh Slide PPTX</strong> untuk membuka di aplikasi PowerPoint lokal.</p>
</div>
