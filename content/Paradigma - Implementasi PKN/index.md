...
<div class="wiki-action-bar">
  ...
  <a href="https://github.com/decaller/wiki-pkn/edit/main/content/Paradigma - Implementasi PKN/index.md" class="wiki-action-item" target="_blank" rel="noopener">✏️ Sunting</a>
  <a href="https://github.com/decaller/wiki-pkn/commits/main/content/Paradigma - Implementasi PKN/index.md" class="wiki-action-item" target="_blank" rel="noopener">📜 Riwayat</a>
...
<div class="wiki-infobox">
  <div class="wiki-infobox-header">Paradigma - Implementasi PKN</div>
  <div class="wiki-infobox-image">
    <div style="padding: 1.25rem 1rem; background: linear-gradient(135deg, #1e3a8a, #0d9488); color: white; text-align: center; border-radius: 6px;">
      ...
      <div style="font-weight: 600; font-size: 0.9rem;">Paradigma - Implementasi PKN</div>
    </div>
  ...
  <table class="wiki-infobox-table">
    <tr>
      <th>Topik Inti</th>
      <td><b>Paradigma - Implementasi PKN</b></td>
    </tr>
    <tr>
...
> **Hakikat Konsep:** **Paradigma - Implementasi PKN** adalah pilar fundamental dalam Manhaj Pendidikan Karakter Nabawiyah yang mengarahkan proses tarbiyah dari penegakan tauhid batin menuju pembiasaan amal shalih lahiriah.
...
> [!warning] Peringatan Risiko: Jebakan Formalitas dalam Direktori Paradigma & Implementasi
...
**Kategori Direktori:** [[Kategori:Manhaj Pendidikan Karakter Nabawiyah]] • [[Kategori:Paradigma - Implementasi PKN]]
