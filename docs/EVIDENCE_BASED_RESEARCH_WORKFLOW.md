...
Pedoman ini menjadi acuan operasional bagi implementasi tugas riset pada [TODO.md](../TODO.md) dan melengkapi spesifikasi [Pipeline 08: Halaman Komparasi Konsep & Kurikulum Pendidikan](../pipeline_designs/08_pipeline_halaman_komparasi_konsep.md).
...
Sintesis riset eksternal wajib dipetakan ke dalam matriks 6 dimensi standar Wiki PKN ([Pipeline 08](../pipeline_designs/08_pipeline_halaman_komparasi_konsep.md)):
